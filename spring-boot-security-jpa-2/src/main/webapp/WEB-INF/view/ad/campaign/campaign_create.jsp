...
<body>
	<form action="${pageContext.request.contextPath}/campaign_create" method="post">
		<div id="create_campaign_step_1" class="create_campaign_step" data-step="1">
			campaign group<br/>
			<input type="radio" id="choose_campaign_type_wc" name="objective" value="1" /><label for="choose_campaign_type_wc">Website Click</label>
			<input type="radio" id="choose_campaign_type_mai" name="objective" value="2" /><label for="choose_campaign_type_mai">Mobile App Install</label>
			<input type="radio" id="choose_campaign_type_mae" name="objective" value="3" /><label for="choose_campaign_type_mae">Mobile App Engagement</label>
			<br/>
