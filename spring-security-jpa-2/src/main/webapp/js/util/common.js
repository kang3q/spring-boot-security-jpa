...
var common = (function() {
	return {
		...
		createAjaxLoading : function(overLayId) {
			...
			//	$('body').append('<div id="div_createAjaxLoading" class="ajaxlodingimg" style="width:168px; height:124px;overflow:hidden;text-indent:-999em;background:url(../images/common/ajaxloding.gif) no-repeat">Loding...</div>');
			//	$('#div_createAjaxLoading').centerLayer();
			//}
			common.createOverLay(overLayId);
			if($('#div_createAjaxLoading').length < 1) {
				$('body').append('<img id="div_createAjaxLoading" src="../images/common/ajaxloding.gif" style="width:12%; height:8.85%; position:absolute; top:45%; left:45%;">');
			}
		},
