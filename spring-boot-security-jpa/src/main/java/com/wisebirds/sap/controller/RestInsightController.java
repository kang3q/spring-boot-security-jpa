...
import com.wisebirds.sap.service.ad.AdCampaignGroupService;
...
public class RestInsightController extends AbstractRestV1_0Controller {
	...
	@Autowired
	AdCampaignGroupService adCampaignGroupService;

	@RequestMapping("/{objectId}/insight")
	public Object getHomePage(@PathVariable String objectId, @ModelAttribute("me") Member me, @ModelAttribute("form") InsightForm insightFormData) throws URISyntaxException {
