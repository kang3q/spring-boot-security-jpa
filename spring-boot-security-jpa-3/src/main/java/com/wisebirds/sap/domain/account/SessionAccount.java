...
public class SessionAccount implements UserDetails, CredentialsContainer {
	...
	private final Account wittAccount;
	 ...
	 */
	public SessionAccount(String username, String password, Collection<? extends GrantedAuthority> authorities, Account wittAccount) {
		this(username, password, true, true, true, true, authorities, wittAccount);
	}
	 ...
	 */
	public SessionAccount(String username, String password, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities, Account wittAccount) {
		...
		this.wittAccount =wittAccount;
		wittAccount.setPassword(null);
	}
	...
	public boolean equals(Object rhs) {
		if (rhs instanceof SessionAccount) {
			return username.equals(((SessionAccount) rhs).username);
		}
		return false;
	}
